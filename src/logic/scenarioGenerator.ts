...
function generateSynopsis(
  ...
  return [
    ...
    '数週間前、源太郎は親族・側近・館の関係者に連絡を入れた。「遺産の整理について話し合いたい。今月中に紫苑館まで来るように」——老齢と体調の衰えを自覚し始めた源太郎が、自らの意志と財産を形にしようとした動きだった。こうして今夜この館には、家族として呼び寄せられた者、健康管理のために定期的に訪れていた者、依頼を受けて館内の仕事を進めていた者、そして長年ここに住み込んで仕えてきた者たちが、それぞれの立場で同じ屋根の下に集うことになった。',
