      ...
      <div className="bg-[#1a0f2e] border-b border-purple-900 px-4 py-3">
        ...
        {!isPuzzle && (
          <p className="text-amber-400/80 text-xs mt-1 leading-relaxed">
            ※選ぶのは「人を殺した犯人」だけです。窃盗・偽造・覗き見などの秘密を抱えた者は多くいますが、
            それらは殺人ではありません——後ろ暗い事情があっても、人を手にかけていなければ犯人ではありません。
            <br />当主・源太郎を殺した犯人に加え、秘密を知られて口封じに使用人を手にかけた犯人も別にいることがあります。殺した者を全員見つけましょう。
          </p>
        )}
      </div>
