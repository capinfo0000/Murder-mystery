export interface ExtraNpcDef {
  ...
  causeHint: string             // coroner-style finding, gradually revealed via cards
...
export const EXTRA_NPCS: ExtraNpcDef[] = [
  {
    ...
    deathLocation: '調理場',
    deathTime: '事件翌日の昼過ぎ',
    causeHint: '遺体には心臓発作の所見。ただし普段から常用していた心臓の薬の量が、記録より減っていた形跡がある。',
  ...
  },
  {
    ...
    causeHint: '死因は転落による頸部骨折。だが手のひらや爪には、とっさに何かを掴もうとした際の不自然な傷が残っていた。',
  ...
  },
  {
    ...
    deathTime: '事件翌朝',
    causeHint: '急性の胃腸症状による衰弱死とされる。だが同じ物を食べた他の使用人には症状が出ておらず、彼女の分にだけ何かがあった可能性がある。',
  ...
  },
  {
    ...
    deathTime: '事件翌日の午前',
    causeHint: '農薬による中毒死とされる。だが本人がいつも使う農薬とは別の、より毒性の強い薬品の成分が検出された。',
  ...
  },
  {
    ...
    deathTime: '事件当夜 深夜',
    causeHint: '脳血管障害による突然死とされる。だが胃の内容物から、通常なら処方されない量の睡眠薬成分が検出された。',
  ...
  },
  {
    ...
    deathTime: '事件翌日の昼',
    causeHint: 'アレルギーによるアナフィラキシーとされる。だが本人は自分のアレルギーを熟知しており、その日の昼食に本来含まれるはずのないアレルゲンが混入していた。',
  ...
  },
  {
    ...
    deathTime: '事件当夜',
    causeHint: '発作による転倒・頭部打撲とされる。だが打撲の位置と角度は単なる転倒では説明しづらく、周囲には争ったような乱れも残っていた。',
  ...
  },
  {
    ...
    deathTime: '事件翌朝',
    causeHint: '整備不良による一酸化炭素中毒とされる。だが前日まで異常のなかった排気系に、人為的に手を加えたような細工の跡が見つかった。',
  ...
  },
  {
    ...
    deathLocation: '自室',
    deathTime: '事件から数日後',
    causeHint: '飲酒による急性肝不全とされる。だが下戸で知られた人物であり、ここ数日だけ毎晩のように飲まされていたという不自然な証言がある。',
  ...
  },
  {
    ...
    deathTime: '事件当夜 深夜',
    causeHint: '巡回中の心停止とされる。だが背中側に、本人では届かない位置の小さな刺し傷のような痕が残っていた。',
